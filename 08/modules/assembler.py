...
from modules.sub_modules.my_parser import Parser
from modules.sub_modules.my_symbol_table import SymbolTable
import modules.sub_modules.my_code as my_code
...
def assemble(asm_path):
    ...
    base_idx = len(asm_path) - 4
    file_base = asm_path[:base_idx]
    p = Parser(asm_path)
